const handler = async (m, {conn}) => {
  m.reply(global.ServerBot);
};
handler.command = /^(ServerBot|ServerBot)$/i;
...
🖥️ *Totalmente compatible con OlympusBot:* Disfruta al máximo de su potencial en nuestros servidores de alto rendimiento, asegurando una experiencia fluida y de alta calidad. El staff de OlympusBot y Olympus Host se encarga de que disfrutes de todas sus funciones al máximo. 😺✨
...
*🟢 Dashboard:*
https://kingsvhost.asifofc.xyz/home

⚙️ *Panel*
https://kingsvhost.asifofc.xyz/store
