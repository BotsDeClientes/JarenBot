...
description = official[0][0] == String(contact[0]) ? 'Solo temas de Yallico Bot' : official[1][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[2][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[3][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : desc === '' ? lenguajeGB.smsContacto5() : desc
correo = official[0][0] == String(contact[0]) ? 'yallico2024@gmail.com' : official[1][0] == String(contact[0]) ? 'yallico2024@gmail.com' : official[2][0] == String(contact[0]) ? lenguajeGB.smsContacto6() : mail === '' ? lenguajeGB.smsContacto6() : mail
...
enlace = official[0][0] == String(contact[0]) ? 'https://instagram.com/yallico.owner' : official[1][0] == String(contact[0]) ? 'https://chat.whatsapp.com/LHo0RmYd3pxAQzp24NYcTV' : official[2][0] == String(contact[0]) ? 'https://whatsapp.com/channel/0029VakjhDP5EjxuMnPrNt0T' : official[3][0] == String(contact[0]) ? 'https://whatsapp.com/channel/0029VakjhDP5EjxuMnPrNt0T' : md 
...
await conn.sendFile(m.chat, pp, 'lp.jpg', cat, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 🥷 𝗦𝘂𝗽𝗲𝗿 𝗬𝗮𝗹𝗹𝗶𝗰𝗼-𝗠𝗗 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb.getRandom()}}})
