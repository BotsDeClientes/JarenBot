...
`.trim()
await conn.sendFile(m.chat, gataImg, 'lp.jpg', menu, m, fakeChannel, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝘖𝘭𝘺𝘮𝘱𝘶𝘴 𝘝𝘦𝘯𝘵𝘢𝘴 🔱', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu }}})
...
{ comando: 'info , infobot', descripcion: false, contexto: 'Información sobre el Bot', showPrefix: true },
]
const commandsJadiBot = [
{ comando: 'comprarbot', descripcion: false, contexto: 'Si Deseas Comprar Bot Escribe El Comando', showPrefix: true },
{ comando: 'ServerBot', descripcion: false, contexto: 'Fijate Donde Esta El Bot', showPrefix: true },
]
