...
title: "💸 VER JAREN BOT 💸",
description: "Infórmate por medios oficiales sobre OlympusBot",
sections: [
{ title: "ℹ️ Información", highlight_label: "Popular",
rows: [
{ header: "✅ Redes", title: "🔓 Para: Todos", description: "Infórmate por medios oficiales sobre OlympusBot", id: usedPrefix + "cuentasgb" },
{ header: "📢 Grupos/Canales", title: "🔓 Para: Todos", description: "¡Te esperamos!", id: usedPrefix + "grupos" },
{ header: "🎁 Donar", title: "🔓 Para: Todos", description: "OlympusBot se mantiene funcionando gracias a donaciones ¡tú también puedes sumarte apoyando el proyecto!", id: usedPrefix + "donar" }
]},
...
{ header: "😺 Estado", title: "🔓 Para: Todos", description: "Conoce en que estado se encuentra OlympusBot", id: usedPrefix + "estado" }
]},
...
{ title: "🛍️ OlympusBot", highlight_label: "Popular",
rows: [
{ header: "💸 ComprarBot", title: "🔓 Para: Todos", description: "Seleccione esto si desea saber el precio del Bot", id: usedPrefix + "ComprarBot" },
{ header: "🎮 ServerBot", title: "🔓 Para: Todos", description: "Conoce en que serve se encuentra olympusbot", id: usedPrefix + "ServerBot" }
]}
]})
...
┃
┃✅ *_CUENTAS OFICIALES JAREN BOT_* ✅
┃➺ _${usedPrefix}cuentas | cuentasgb_
┃
*╰━━━━━━━━━━━━━⬣*`.trim()
await conn.sendFile(m.chat, gataImg, 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝙹𝚊𝚛𝚎𝚗 𝙸𝚗𝚏𝚕𝚞𝚎𝚗𝚌𝚎𝚛 💸', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu}}}) 
