...
this.sendMessage(m.chat, {text: `🐈 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝙂𝘼𝙏𝘼𝘾𝙊𝙄𝙉𝙎`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝙹𝚊𝚛𝚎𝚗 𝙸𝚗𝚏𝚕𝚞𝚎𝚗𝚌𝚎𝚛 💸 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝙹𝚊𝚛𝚎𝚗 𝙸𝚗𝚏𝚕𝚞𝚎𝚗𝚌𝚎𝚛 💸 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
//this.reply(m.chat, `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`, m)
continue //Sin límite
}
if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont9']()} *${plugin.level}* ${lenguajeGB['smsCont10']()} *${_user.level}* ${lenguajeGB['smsCont11']()} *${usedPrefix}nivel*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝙹𝚊𝚛𝚎𝚗 𝙸𝚗𝚏𝚕𝚞𝚎𝚗𝚌𝚎𝚛 💸 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
...
"thumbnail": apii.data, 
"title": [wm, '𝙹𝚊𝚛𝚎𝚗 𝙸𝚗𝚏𝚕𝚞𝚎𝚗𝚌𝚎𝚛 💸'].getRandom(),
"containsAutoReply": true,
"mediaType": 1, 
sourceUrl: accountsgb ? accountsgb : 'https://github.com/YallicoOwner/OlympusOfc' }}}, { quoted: fkontak2 })
apii.data = ''
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '𝙹𝚊𝚛𝚎𝚗 𝙸𝚗𝚏𝚕𝚞𝚎𝚗𝚌𝚎𝚛 💸'].getRandom(), thumbnail: gataImg, sourceUrl: accountsgb }}}}, tg)
